...
| 기능명                   | 담당자 | 주요 기능 설명                                          |
| --------------------- | --- | ------------------------------------------------- |
| **스톱워치**              | 고동현 | 공부 시간 측정을 위한 스톱워치 기능 구현 및 누적 시간 저장(localStorage) |
| **명언 표시**             | 고동현 | 학습 동기를 위한 명언 API 연동 및 랜덤 명언 출력 기능                 |
| **할 일 목록 (TodoList)** | 김경민 | 할 일 추가/완료, 오늘·주간·완료 탭 구성, 체크박스 상태 관리,완료된 할일 갯수 저장(localStorage)            |
| **학습 업적 로그**          | 백승현 | 공부 시간·할일· AI 질문 수 통합하여 로컬 스토리지 기반 학습 업적 기록 생성         |
| **AI 학습 보조**          | 송민재 | Gemini API 연동을 통한 AI 질문/답변 기능 및 질문 로그 저장,질문 수량 갯수 저장(localStorage)          |
...
| 날짜  | 내용                     |
| --- | ---------------------- |
| 월요일 | 주제 선정, Git & HTML,CSS 구조 세팅 |
| 화요일 | 본격적인 기능 개발 시작        |
| 수요일 | 기능 개발 계속               |
| 목요일 | 기능 복잡, 모듈화, 버전 태깅 준비  |
| 금요일 | develop 브랜치 1차 병합, 1차 버그 픽스      |
| 토요일 | 개발 지속      |
| 일요일 | 기능 마무리 및 테스트           |
| 월요일 | 전체 버그 피스 및 마무리         |
| 화요일 | PPT 제작, README 작성, 회고록 작성      |
| 수요일 | 최종 발표                  |
...
- **김경민**: JS 투두리스트 기능 구현
- **백승현**: 유저 정보 그래프 랜더링 CSS
- **송민재**: 제미나이 API 로 호출해서 로그 받기
